	...
	<div class="container" style="margin-top:20px">
		...
		<table class="table table-striped table-hover table-sm table-bordered">
			...
			<tbody>
				...
				$sql = mysqli_query($koneksi, "SELECT * FROM jenis_lomba ORDER BY ID_JENIS_LOMBA DESC") or die(mysqli_error($koneksi));
				...
				if(mysqli_num_rows($sql) > 0){
					...
					while($data = mysqli_fetch_assoc($sql)){
						...
						<tr>
                            ...
                            <td>'.$data['BIAYA'].'</td>
							<td>
								<a href="ubah.php?id='.$data['ID_JENIS_LOMBA'].'" class="badge badge-warning">Edit</a>
								<a href="hapus.php?id='.$data['ID_JENIS_LOMBA'].'" class="badge badge-danger" onclick="return confirm(\'Yakin ingin menghapus data ini?\')">Delete</a>
							</td>
						</tr>
						';
						$no++;
