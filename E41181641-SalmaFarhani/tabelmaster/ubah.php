...
<body>
	...
	<div class="container" style="margin-top:20px">
		...
		if(isset($_GET['ID_RAYON'])){
			...
			$select = mysqli_query($koneksi, "SELECT * FROM rayon WHERE ID_RAYON='$id'") or die(mysqli_error($koneksi));
		...
		if(isset($_POST['submit'])){
			...
			$sql = mysqli_query($koneksi, "UPDATE rayon SET NAMA_RAYON='$nama' WHERE ID_RAYON='$id'") or die(mysqli_error($koneksi));
			
			if($sql){
				echo '<script>alert("Berhasil menyimpan data."); document.location="ubah.php?ID_RAYON='.$id.'";</script>';
			}else{
