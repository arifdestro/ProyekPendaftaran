...
<head>
	<meta charset="utf-8">
	<title>Tampilan Keranjang Daftar</title>
	...
	<nav class="navbar navbar-default">
	  <div class="container-fluid">
	    <div class="navbar-header">
	      ...
	      <a class="navbar-brand" href="#">Keranjang Pendaftaran</a>
	    </div>
			...
			<table class="table table-bordered table-striped">
				...
				<tbody>
					<?php
						...
						$sql = "SELECT daftar.ID_DAFTAR, siswa.NISN , siswa.NAMA_SISWA, siswa.FOTO, jenis_lomba.NAMA_LOMBA,jenis_lomba.BIAYA, sekolah.NAMA_SEKOLAH
								FROM melakukan,daftar,siswa,jenis_lomba,sekolah
								WHERE melakukan.ID_DAFTAR = daftar.ID_DAFTAR
								AND melakukan.NISN = siswa.NISN
								AND ID_DAFTAR IN (".implode(',',$_SESSION['cart']).")";
						$query = $conn->query($sql);
							while($row = $query->fetch_assoc()){
								...
								<tr>
									...
									<td><?php //echo number_format($_SESSION['qty_array'][$index]*$row[''], 2); ?></td>
									<?php //$total += $_SESSION['qty_array'][$index]*$row['']; ?>
								</tr>
								<?php
								$index ++;
							}
							...
							?>
							<tr>
								<td colspan="4" class="text-center">Tidak ada Pendaftaran dalam Cart</td>
							</tr>
							<?php
						}
