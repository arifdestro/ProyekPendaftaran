    ...
    <div id="wrapper">
        ...
        <div class="form-group row">
            ...
            <div class="form-group row">
				...
				<div class="col-sm-10">
					<input type="text" name="NAMA_SISWA" class="form-control" placeholder="masukkan nama, maksimal =50 digit"  required>
				</div>
			</div>
            ...
            <!-- <div class="form-group row">
				...
				<div class="col-sm-10">
					<input type="file" name="FOTO" placeholder="maksimal ukuran file 8MB" required>
				</div>
			</div> -->
